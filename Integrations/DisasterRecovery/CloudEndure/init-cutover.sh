...
cd /tmp/
nohup wget ${SCRIPT_LOCATION}/CE_Cisco_Integration_Launch_Target_2_6.py &>/dev/null &
wait
python CE_Cisco_Integration_Launch_Target_2_6.py -u $user -p $passwd -n $hostnamece -j $ceproject
exit 0
